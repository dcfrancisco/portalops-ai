...
<div class="portalops-dashboard-layout">
  <div class="portalops-dashboard-main">
    <div class="portalops-dashboard-shell">
      ...
      <div class="portalops-grid portalops-grid-secondary portalops-grid-secondary-dashboard">
        <section class="card portalops-insights-panel">
          <div class="card-body">
            <div class="portalops-insights-header">
              <div>
                <div class="portalops-section-title">PortalOps Insights</div>
                <p class="portalops-section-subtitle">Recommended actions based on current operational signals.</p>
              </div>
            </div>
        ...
        <section class="card portalops-actions-panel">
          <div class="card-body">
            <div class="portalops-section-title">Quick Actions</div>
            <p class="portalops-section-subtitle">Jump straight to the highest-value admin tasks.</p>
  ...
  <aside class="portalops-dashboard-assistant-column">
    <div class="portalops-dashboard-assistant-sticky">
      <%@ include file="/components/assistant_card.jspf" %>
    </div>
  </aside>
</div>
