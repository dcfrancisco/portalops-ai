...
public class ListSkillsSkill implements Skill {

	public static final String NAME = "ListSkills";
	...
	public Object execute(String prompt) {
		...
		return AgentResponse.success(
			ManagementQueryDataFactory.createListSkills(
				runtimeMetadataData),
	...
	public List<String> getCapabilities() {
		return List.of("List PortalOps skills");
	}

	@Override
	public String getDescription() {
		return "Lists the currently registered PortalOps skills.";
	}
