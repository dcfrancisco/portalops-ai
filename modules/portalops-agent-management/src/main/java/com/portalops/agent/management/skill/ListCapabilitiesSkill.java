...
public class ListCapabilitiesSkill implements Skill {

	public static final String NAME = "ListCapabilities";
	...
	public Object execute(String prompt) {
		...
		return AgentResponse.success(
			ManagementQueryDataFactory.createListCapabilities(
				runtimeMetadataData),
	...
	public List<String> getCapabilities() {
		return List.of("List PortalOps capabilities");
	}

	@Override
	public String getDescription() {
		return "Lists the administrator-facing capabilities currently available in PortalOps.";
	}
