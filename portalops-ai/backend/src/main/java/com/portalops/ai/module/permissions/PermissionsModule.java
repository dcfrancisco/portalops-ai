package com.portalops.ai.module.permissions;
...
@Component
public class PermissionsModule implements CapabilityModule {

    private final LiferayGateway liferayGateway;

    public PermissionsModule(LiferayGateway liferayGateway) {
    ...
    public CommandResponse handle(CommandIntent commandIntent, AccessContext accessContext) {
        return new CommandResponse(
                ...
                "Permissions governance report generated for " + commandIntent.qualifier(),
                Map.of("items", liferayGateway.loadPermissionRisks()));
    }
}